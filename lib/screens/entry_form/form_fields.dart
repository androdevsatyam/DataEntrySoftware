...
class FormFields extends StatelessWidget {
  ...
  final Function(String value) onApplicantTypeChange,
      ...
      ondiplomaUniversityApprovedChange,
      ongraduateUniversityApprovedChange,
      onpostGraduateUniversityApprovedChange,
  ...
  final FocusNode applicantTypeFocusNode,
  ...
  const FormFields(
      {Key? key,
        ...
        required this.ondiplomaUniversityApprovedChange,
        required this.ongraduateUniversityApprovedChange,
        required this.onpostGraduateUniversityApprovedChange,
        ...
        required this.onClassMemberChange,
        required this.onmemberPlanChange,
        required this.onClassAssetChange,
        ...
        required this.memberPlanFocusNode,
            ...
            children: [
              ...
              Expanded(
                  child: _dropDownField(
                      ...
                      error: errorMsg.contains(AppRes.applicationTypeHint)
                          ? errorMsg
                          : '',
              ...
              Expanded(
                  child: _textField(
                      ...
                      error: errorMsg.contains(AppRes.memberShipHint)
                          ? errorMsg
                          : '',
              ...
              Expanded(
                  child: _datePicker(
                      ...
                      error: errorMsg.contains(AppRes.receivedDateHint)
                          ? errorMsg
                          : '',
            ...
            children: [
              ...
              Expanded(
                  child: _textField(
                      ...
                      inputFormaters: FilteringTextInputFormatter.allow(
                          RegExp(AppRes.normalName)))),
              //-----FATHER NAME----
              Expanded(
                  child: _textField(
                      controller: fatherName,
                      focusNode: fatherNameFocusNode,
                      error: errorMsg.contains(AppRes.fatherNameHint)
                          ? errorMsg
                          : '',
              ...
              Expanded(
                  child: _dropDownField(
                      ...
                      error:
                      errorMsg.contains(AppRes.genderHint) ? errorMsg : '',
            ...
            children: [
              ...
              Expanded(
                  child: _textField(
                      ...
                      error:
                      errorMsg.contains(AppRes.addressHint) ? errorMsg : '',
              ...
              Expanded(
                  child: _dropDownField(
                      ...
                      error:
                      errorMsg.contains(AppRes.stateHint) ? errorMsg : '',
                      dropList: stateList,
              ...
              Expanded(
                  child: _textField(
                      ...
                      error:
                      errorMsg.contains(AppRes.pincodeHint) ? errorMsg : '',
            ...
            children: [
              ...
              Expanded(
                  child: _textField(
                      ...
                      error:
                      errorMsg.contains(AppRes.mobileHint) ? errorMsg : '',
              ...
              Expanded(
                  child: _textField(
                      ...
                      error:
                      errorMsg.contains(AppRes.emailHint) ? errorMsg : '',
              ...
              Expanded(
                  child: _textField(
                      ...
                      error:
                      errorMsg.contains(AppRes.invoiceHint) ? errorMsg : '',
              ...
              Expanded(
                  child: _datePicker(
                      ...
                      error: errorMsg.contains(AppRes.invoiceDateHint)
                          ? errorMsg
                          : '',
                      startDate: DateTime.now(),
            ...
            children: [
              ...
              Expanded(
                  child: _textField(
                      ...
                      error:
                      errorMsg.contains(AppRes.aadhaarHint) ? errorMsg : '',
                  ...
                  children: [
                    ...
                    Expanded(
                        child: _textField(
                            ...
                            error: errorMsg.contains(AppRes.diplomaDegree)
                                ? errorMsg
                                : '',
                    ...
                    Expanded(
                        child: _dropDownField(
                            ...
                            error: errorMsg.contains(
                                'diploma ${AppRes.haveMarkSheetHint}')
                                ? errorMsg
                                : '',
                  ...
                  children: [
                    ...
                    Expanded(
                        child: _textField(
                            ...
                            error: errorMsg.contains(
                                'diploma ${AppRes.universityNameHint}')
                                ? errorMsg
                                : '',
                    ...
                    Expanded(
                        child: _dropDownField(
                            ...
                            error: errorMsg.contains(
                                'diploma ${AppRes.universityLocationHint}')
                                ? errorMsg
                                : '',
                    ...
                    Expanded(
                        child: _dropDownField(
                            controller: TextEditingController(
                                text: diplomaUniversityApproved),
                            focusNode: diplomaUniversityApprovedFocusNode,
                            error: errorMsg.contains(
                                'diploma ${AppRes.universityApprovedHint}')
                                ? errorMsg
                                : '',
                            hint: AppRes.universityApprovedHint,
                            dropList: AppRes.approvedList,
                            onChangeMethod: ondiplomaUniversityApprovedChange,
                            context: context)),
                    //-----PASSING YEAR----
                    Expanded(
                        child: _yearPicker(
                            ...
                            error: errorMsg.contains(
                                'diploma ${AppRes.passingYearHint}')
                                ? errorMsg
                                : '',
                  ...
                  children: [
                    Expanded(
                        child: _textField(
                            ...
                            error: errorMsg.contains(AppRes.graduateDegree)
                                ? errorMsg
                                : '',
                    ...
                    Expanded(
                        child: _dropDownField(
                            ...
                            error: errorMsg.contains(
                                'graduation ${AppRes.haveMarkSheetHint}')
                                ? errorMsg
                                : '',
                            hint: AppRes.haveMarkSheetHint,
                            dropList: AppRes.markSheetList,
                  ...
                  children: [
                    ...
                    Expanded(
                        child: _textField(
                            ...
                            error: errorMsg.contains(
                                'graduation ${AppRes.universityNameHint}')
                                ? errorMsg
                                : '',
                            hint: AppRes.universityNameHint,
                            inputFormaters: FilteringTextInputFormatter.allow(
                    ...
                    Expanded(
                        child: _dropDownField(
                            ...
                            error: errorMsg.contains(
                                'graduation ${AppRes.universityLocationHint}')
                                ? errorMsg
                                : '',
                            hint: AppRes.universityLocationHint,
                            dropList: stateList,
                    ...
                    Expanded(
                        child: _dropDownField(
                            controller: TextEditingController(
                                text: graduateUniversityApproved),
                            focusNode: graduateUniversityApprovedFocusNode,
                            error: errorMsg.contains(
                                'graduation ${AppRes.universityApprovedHint}')
                                ? errorMsg
                                : '',
                            hint: AppRes.universityApprovedHint,
                            dropList: AppRes.approvedList,
                            onChangeMethod: ongraduateUniversityApprovedChange,
                            context: context)),
                    //-----PASSING YEAR----
                    Expanded(
                        child: _yearPicker(
                            ...
                            error: errorMsg.contains(
                                'graduation ${AppRes.passingYearHint}')
                                ? errorMsg
                                : '',
                            startDate: DateTime((DateTime.now().year - 3)),
                            hint: AppRes.passingYearHint,
                  ...
                  children: [
                    Expanded(
                        child: _textField(
                            ...
                            error: errorMsg.contains(
                                'post graduation ${AppRes.postGraduateDegree}')
                                ? errorMsg
                                : '',
                    ...
                    Expanded(
                        child: _dropDownField(
                            ...
                            error: errorMsg.contains(
                                'post graduation ${AppRes.haveMarkSheetHint}')
                                ? errorMsg
                                : '',
                            hint: AppRes.haveMarkSheetHint,
                            dropList: AppRes.markSheetList,
                  ...
                  children: [
                    ...
                    Expanded(
                        child: _textField(
                            ...
                            error: errorMsg.contains(
                                'post graduation ${AppRes.universityNameHint}')
                                ? errorMsg
                                : '',
                            hint: AppRes.universityNameHint,
                            inputFormaters: FilteringTextInputFormatter.allow(
...
//-----UNIVERSITY LOCATION.-----
                    Expanded(
                        child: _dropDownField(
                            ...
                            error: errorMsg.contains(
                                'post graduation ${AppRes.universityLocationHint}')
                                ? errorMsg
                                : '',
                            hint: AppRes.universityLocationHint,
                            dropList: stateList,
...
/*-----UNIVERSITY Approved.-----*/
                    Expanded(
                        child: _dropDownField(
                            controller: TextEditingController(
                                text: postGraduateUniversityApproved),
                            focusNode: postGraduateUniversityNameFocusNode,
                            error: errorMsg.contains(
                                'post gradutaion ${AppRes.universityApprovedHint}')
                                ? errorMsg
                                : '',
                            hint: AppRes.universityApprovedHint,
                            dropList: AppRes.approvedList,
...
/*-----PASSING YEAR----*/
                    Expanded(
                        child: _yearPicker(
                            ...
                            error: errorMsg.contains(
                                'post gradutaion ${AppRes.passingYearHint}')
                                ? errorMsg
                                : '',
                            startDate: DateTime((DateTime.now().year - 3)),
                            hint: AppRes.passingYearHint,
                  ...
                  children: [
                    ...
                    Expanded(
                        child: _dropDownField(
                          ...
                          error: errorMsg.contains(AppRes.employementStatus)
                              ? errorMsg
                              : '',
                    ...
                    Expanded(
                        child: _textField(
                          ...
                          error:
                          errorMsg.contains(AppRes.designation) ? errorMsg : '',
                          inputFormaters: FilteringTextInputFormatter.allow(
                              RegExp(AppRes.normalName)),
                  ...
                  children: [
                    ...
                    Expanded(
                        child: _yearPicker(
                          ...
                          error:
                          errorMsg.contains(AppRes.periodFrom) ? errorMsg : '',
                    ...
                    Expanded(
                        child: _textField(
                          ...
                          error: errorMsg.contains(AppRes.experienceInYears)
                              ? errorMsg
                              : '',
                          inputFormaters:
                          FilteringTextInputFormatter.allow(RegExp("[0-9]")),
                    ...
                    Expanded(
                        child: _textField(
                          ...
                          error: errorMsg.contains(AppRes.experienceInMonths)
                              ? errorMsg
                              : '',
                          inputFormaters:
                          FilteringTextInputFormatter.allow(RegExp("[0-9]")),
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                        child: _dropDownField(
                          controller: TextEditingController(text: membershipClass),
                          focusNode: membershipClassFocusNode,
                          error: errorMsg.contains(AppRes.membershipClass)
                              ? errorMsg
                              : '',
                          hint: AppRes.membershipClass,
                          dropList: AppRes.classOfMembershipList,
                          onChangeMethod: onClassMemberChange,
                          context: context,
                        )),
                    Expanded(
                        child: _dropDownField(
                          controller: TextEditingController(text: assetClass),
                          focusNode: memberPlanFocusNode,
                          error:
                          errorMsg.contains(AppRes.assetClass) ? errorMsg : '',
                          hint: AppRes.assetClass,
                          dropList: AppRes.classOfAssetList,
                          onChangeMethod: onClassAssetChange,
                          context: context,
                        )),
                    Expanded(
                        child: _dropDownField(
                          controller: TextEditingController(text: memberPlan),
                          focusNode: annualLMFocusNode,
                          error:
                          errorMsg.contains(AppRes.memberPlan) ? errorMsg : '',
                          hint: AppRes.memberPlan,
                          dropList: AppRes.plansList,
                          onChangeMethod: onmemberPlanChange,
                          context: context,
                        )),
                    Expanded(
                        child: _dropDownField(
                  ...
                  children: [
                    ...
                    Expanded(
                        child: _dropDownField(
                          ...
                          error:
                          errorMsg.contains(AppRes.emailSent) ? errorMsg : '',
                          dropList: AppRes.markSheetList,
                    ...
                    Expanded(
                        child: _dropDownField(
                          ...
                          error: errorMsg.contains(AppRes.membershipStatus)
                              ? errorMsg
                              : '',
                    ...
                    Expanded(
                        child: _datePicker(
                          ...
                          error:
                          errorMsg.contains(AppRes.meetingDate) ? errorMsg : '',
                  ...
                  children: [
                    Expanded(
                        child: _textField(
                          ...
                          error:
                          errorMsg.contains(AppRes.approvedBy) ? errorMsg : '',
                          inputFormaters: FilteringTextInputFormatter.allow(
                              RegExp(AppRes.normalName)),
                    ...
                    Expanded(
                        child: _yearPicker(
                          ...
                          error: errorMsg.contains(AppRes.financialYear)
                              ? errorMsg
                              : '',
  ...
  Widget _textField(
    ...
    return Container(
        ...
        child: inputFormaters == null
          ...
          onChanged: (value) {},
          showCursor: keyBoardType == null ? true : false,
          textCapitalization: hint.contains(AppRes.panHint)
          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
                borderSide: BorderSide(
                    color: error.isNotEmpty ? ColorRes.red : ColorRes.red,
                    width: 1)),
            contentPadding: const EdgeInsets.only(bottom: 10, left: 10),
          ),
        ));
                      ...
                      child: YearPicker(
                        ...
                        onChanged: (DateTime value) {
                          ...
                          if (hint == AppRes.periodTo ||
                            ...
                            onChangeMethod('$formattedDate-${DateFormat('yyyy').format(DateTime(DateTime(int.parse(formattedDate)).year + 1))}');
                          }
                          else {
                            onChangeMethod(formattedDate);
                          }
  ...
  Widget _dropDownField(
      {required TextEditingController controller,
        ...
        required BuildContext context}) {
    print(
        "_dropDownField: controller=${controller.text},error=$error,hint=$hint,list=${dropList}");
    return Container(
      margin: EdgeInsets.only(left: 7, right: 7),
      height: 60,
      decoration: BoxDecoration(
